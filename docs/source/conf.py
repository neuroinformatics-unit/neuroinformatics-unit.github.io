...
linkcheck_ignore = [
    ...
    "https://neuropixelsgroup.slack.com/" # HTTP 403 Forbidden: doesn't allow automatic link checkers
...
exclude_patterns = [
    ...
    "howto/electrophysiology/example_pipelines/auto_examples_ephys/*.ipynb",
    "howto/electrophysiology/example_pipelines/auto_examples_ephys/*.py",
]
...
sphinx_gallery_conf = {
     'examples_dirs': ["howto/electrophysiology/example_pipelines/examples"],   # path to your example scripts
     'gallery_dirs': ["howto/electrophysiology/example_pipelines/auto_examples_ephys"],    # path to where to save gallery generated output
}
