...
| Tuesday<br>afternoon   | Registration and segmentation        | Hands-on tutorials for using [`brainreg`](https://github.com/brainglobe/brainreg) to map data to a BrainGlboe atlas and using [`brainglobe-segmentation`](https://github.com/brainglobe/brainglobe-segmentation) to segment structures in whole brain microscopy images.                                    |
