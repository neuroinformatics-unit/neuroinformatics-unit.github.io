...
As your community grows, managing all these communication channels can become a burden. There are bad actors out there, and you will have to work to keep a high signal-to-noise ratio. This means moderation. You need a clear [code of conduct](https://opensource.guide/code-of-conduct/)[^code-of-conduct]—ideally from the very start—and you must enforce it consistently. You may also need [governance structures](https://opensource.guide/leadership-and-governance/) and perhaps a dedicated community manager.
...
[^code-of-conduct]: The [Contributor Covenant](https://www.contributor-covenant.org) is a good starting point—it's what we use.
