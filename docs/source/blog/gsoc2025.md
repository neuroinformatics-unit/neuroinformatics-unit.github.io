...
1. **Checking our [project ideas list](../get-involved/gsoc/2025/index)**, to see what projects we have on offer. Our projects for GSoC 2025 are organised under [four of our software tools](../get-involved/gsoc/2025/projects/index). This is not a definitive list, so if you have a project idea that fits within our scope, feel free to propose it.
...
4. **Submit your application to the GSoC system**. Remember to submit your application before the 8th April deadline! All applications must go through [Google's application system](https://summerofcode.withgoogle.com/) - please do not send any applications directly to the NIU team.
