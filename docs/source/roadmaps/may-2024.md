...
- A common interface to machine-learning based video behavioural analysis tools
- A common interface to machine-learning based behavioural classification tools
